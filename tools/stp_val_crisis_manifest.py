...
STP_CRISIS_FOCUS_LAYOUT = {
    ...
    "STP_The_Last_Confession": ("STP_The_Old_Man_On_The_Balcony", 1, 2),
    "STP_Turn_The_Young_Officers": ("STP_The_Old_Man_On_The_Balcony", 3, 2),
    "STP_Cut_The_Silk_Leash": ("STP_The_Old_Man_On_The_Balcony", 5, 2),
    "STP_The_Hand_That_Still_Signs": ("STP_The_Old_Man_On_The_Balcony", 1, 2),
    "STP_Feed_The_Festival_Police": ("STP_The_Old_Man_On_The_Balcony", 3, 2),
    "STP_Renew_The_Cultural_Mandate": ("STP_The_Old_Man_On_The_Balcony", 5, 2),
    "STP_Call_For_Shabrat": ("STP_The_Old_Man_On_The_Balcony", 1, 3),
    "STP_Garrisons_Hesitate": ("STP_The_Old_Man_On_The_Balcony", 3, 3),
    "STP_The_People_Stop_Singing": ("STP_The_Old_Man_On_The_Balcony", 5, 3),
    "STP_Seal_The_Western_Wing": ("STP_The_Old_Man_On_The_Balcony", 1, 3),
    "STP_Garrisons_Swear_Loyalty": ("STP_The_Old_Man_On_The_Balcony", 3, 3),
    "STP_Drown_The_Rumours_In_Music": ("STP_The_Old_Man_On_The_Balcony", 5, 3),
}
