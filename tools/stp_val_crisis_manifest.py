...
# Kept as an empty compatibility interface for older tooling. Calendar and
# narrative progression must never create nodes in the playable focus tree.
STP_SPINE_FOCUS_STAGES = {}
STP_CALENDAR_LORE_EVENTS = {
    1: ("stp_lore.1",),
    2: ("stp_lore.2", "stp_lore.3"),
    3: ("stp_lore.7", "stp_lore.11"),
    4: (),
    5: ("stp_lore.12",),
}
STP_STORY_ONLY_FOCUS_IDS = (
    "STP_Nectar_of_the_Gods",
    "STP_The_Man_Who_Bought_The_Sky",
    "STP_When_The_Guarantee_Died",
    "STP_The_Dying_Feast",
    "STP_The_Doctors_Lie",
    "STP_The_Last_Signature",
    "STP_Cancel_The_Morning_Address",
    "STP_A_Glass_Raised_Too_High",
    "STP_The_Father_Of_Peace_Is_Gone",
    "STP_The_Mountain_Window",
    "STP_No_One_Controls_The_Transition",
    "STP_A_General_Takes_The_Passes",
...
STP_CRISIS_FOCUS_STAGES = {
    ...
    "STP_Divide_The_Command_Registers": 2,
    "STP_Establish_Reserve_Communications": 2,
    "STP_Turn_The_Young_Officers": 3,
    "STP_Feed_The_Festival_Police": 3,
    "STP_The_Last_Confession": 3,
    "STP_The_Hand_That_Still_Signs": 3,
    "STP_Cut_The_Silk_Leash": 3,
    "STP_Renew_The_Cultural_Mandate": 3,
    "STP_Unify_The_Administrative_Protocol": 3,
    "STP_Assign_Regional_Command_Groups": 3,
    "STP_Close_The_External_Channels": 3,
    "STP_Approve_The_Emergency_Protocol": 4,
...
STP_CRISIS_FOCUS_LAYOUT = {
    "STP_The_Old_Man_On_The_Balcony": (None, -3, 0),
    "STP_Count_The_Loyalists": ("STP_The_Old_Man_On_The_Balcony", 2, 0),
    "STP_The_City_Still_Dances": ("STP_The_Old_Man_On_The_Balcony", 4, 0),
    "STP_Foreign_Guests_At_The_Banquet": ("STP_The_Old_Man_On_The_Balcony", 6, 0),
    "STP_Show_Him_The_Truth": ("STP_The_Old_Man_On_The_Balcony", 3, 1),
    "STP_Govern_In_His_Name": ("STP_The_Old_Man_On_The_Balcony", 3, 1),
    "STP_Divide_The_Command_Registers": ("STP_The_Old_Man_On_The_Balcony", 2, 2),
    "STP_Establish_Reserve_Communications": ("STP_The_Old_Man_On_The_Balcony", 4, 2),
    "STP_The_Last_Confession": ("STP_The_Old_Man_On_The_Balcony", 1, 3),
    "STP_Turn_The_Young_Officers": ("STP_The_Old_Man_On_The_Balcony", 3, 3),
    "STP_Cut_The_Silk_Leash": ("STP_The_Old_Man_On_The_Balcony", 5, 3),
    "STP_The_Hand_That_Still_Signs": ("STP_The_Old_Man_On_The_Balcony", 1, 3),
    "STP_Feed_The_Festival_Police": ("STP_The_Old_Man_On_The_Balcony", 3, 3),
    "STP_Renew_The_Cultural_Mandate": ("STP_The_Old_Man_On_The_Balcony", 5, 3),
    "STP_Unify_The_Administrative_Protocol": ("STP_The_Old_Man_On_The_Balcony", 1, 4),
    "STP_Assign_Regional_Command_Groups": ("STP_The_Old_Man_On_The_Balcony", 3, 4),
    "STP_Close_The_External_Channels": ("STP_The_Old_Man_On_The_Balcony", 5, 4),
    "STP_Approve_The_Emergency_Protocol": ("STP_The_Old_Man_On_The_Balcony", 3, 5),
    "STP_Call_For_Shabrat": ("STP_The_Old_Man_On_The_Balcony", 1, 6),
    "STP_Garrisons_Hesitate": ("STP_The_Old_Man_On_The_Balcony", 3, 6),
    "STP_The_People_Stop_Singing": ("STP_The_Old_Man_On_The_Balcony", 5, 6),
    "STP_Seal_The_Western_Wing": ("STP_The_Old_Man_On_The_Balcony", 1, 6),
    "STP_Garrisons_Swear_Loyalty": ("STP_The_Old_Man_On_The_Balcony", 3, 6),
    "STP_Drown_The_Rumours_In_Music": ("STP_The_Old_Man_On_The_Balcony", 5, 6),
}
STP_CRISIS_FOCUS_REWARDS = {
    ...
    "STP_Divide_The_Command_Registers": "STP_focus_command_registers_divided",
    "STP_Establish_Reserve_Communications": "STP_focus_reserve_communications_ready",
    "STP_Turn_The_Young_Officers": "STP_focus_young_officers_open",
    "STP_Feed_The_Festival_Police": "STP_focus_garrison_rotation_open",
    "STP_The_Last_Confession": "STP_focus_black_ledger_open",
    ...
    "STP_Unify_The_Administrative_Protocol": "STP_focus_administrative_protocol_ready",
    "STP_Assign_Regional_Command_Groups": "STP_focus_regional_command_groups_ready",
    "STP_Close_The_External_Channels": "STP_focus_external_channels_controlled",
    "STP_Approve_The_Emergency_Protocol": "STP_focus_emergency_protocol_ready",
...
VAL_FOCUS_REWARD_TOKENS = {
    ...
    "VAL_The_Weaponry_Baron": ("VAL_apply_contract_administration_1 = yes", "ADISCORD_STP_VAL_effect_value value = 10", "VAL_change_contract_authority = yes"),
    "VAL_Price_Of_Loyalty": ("VAL_captain_retainers_unlocked", "ADISCORD_economy_receive_15 = yes", "ADISCORD_STP_VAL_effect_value value = 5", "VAL_change_contract_authority = yes"),
    "VAL_Count_The_Captains": ("VAL_negotiation_posture_visible", "VAL_apply_contract_army_1 = yes", "ADISCORD_STP_VAL_effect_value value = 5", "VAL_change_contract_authority = yes"),
    ...
    "VAL_Brokered_Steel": ("VAL_broad_resource_network", "ADISCORD_economy_receive_15 = yes", "VAL_refresh_contract_modifier = yes"),
    ...
    "VAL_The_Mercenary_State": ("VAL_apply_contract_army_1 = yes", "VAL_doctrine_choice_unlocked"),
    "VAL_Hire_Out_War": ("VAL_foreign_contracts_unlocked", "ADISCORD_economy_receive_15 = yes"),
