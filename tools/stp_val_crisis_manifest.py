...
VAL_FOCUS_REWARD_TOKENS = {
    ...
    "VAL_Export_Rifles_Not_Promises": ("VAL_supply_contracts", "VAL_change_contract_authority = { value = 5 }"),
    "VAL_The_Mercenary_State": ("add_army_experience = 10", "VAL_doctrine_choice_unlocked"),
    ...
    "VAL_Morns_Supply_Trains": ("VAL_supply_preparation", "VAL_change_contract_authority = { value = 5 }"),
    ...
    "VAL_Dead_Villages_Still_Count": ("VAL_ash_model_selected", "VAL_change_contract_authority = { value = 5 }"),
    ...
    "VAL_Different_Views_On_Freedom": ("VAL_northern_operations_unlocked", "VAL_change_contract_authority = { value = 5 }"),
