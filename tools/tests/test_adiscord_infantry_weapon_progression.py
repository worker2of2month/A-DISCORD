...
class GlobalInfantryWeaponProgressionTests(unittest.TestCase):
    ...
    def test_country_body_meshes_use_their_selected_forms(self) -> None:
        ...
        expected_meshes = {
            ...
            "CIN_infantry_entity": "APH_irregular_infantry_mesh",
            "CIN_infantry_2_entity": "APH_irregular_infantry_mesh",
            "OSF_infantry_entity": "APH_irregular_infantry_mesh",
            "OSF_infantry_2_entity": "APH_irregular_infantry_mesh",
