...
try:
    from tools.build_adiscord_northern_countries import format_provinces, load_definition
    ...
    from build_adiscord_northern_countries import format_provinces, load_definition
