...
Программы: «Воркерландские контракты горят», «Пересчитать пустые дворы»,
«Мобилизовать машинные мастерские», «Арсеналы в три смены», «Учёт
неприкосновенного резерва» и «Экономическое чудо»
