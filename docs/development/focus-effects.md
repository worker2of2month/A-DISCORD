...
или полевой профессиональный штаб. Внешний статус также обязателен: протекторат
Нодрула и вооружённая самостоятельность имеют собственные продолжения и сходятся
в `STP_pw_party_foreign_settlement`. Только четыре закрытых оси открывают
